...
import net.minecraft.server.v1_13_R1.BlockLeaves1;
import net.minecraft.server.v1_13_R1.BlockLog1;
import net.minecraft.server.v1_13_R1.BlockPosition;
import net.minecraft.server.v1_13_R1.BlockWood;
...
import net.minecraft.server.v1_13_R1.DataConverter;
...
import net.minecraft.server.v1_13_R1.WorldGenAcaciaTree;
import net.minecraft.server.v1_13_R1.WorldGenBigTree;
import net.minecraft.server.v1_13_R1.WorldGenDungeons;
import net.minecraft.server.v1_13_R1.WorldGenForest;
import net.minecraft.server.v1_13_R1.WorldGenForestTree;
import net.minecraft.server.v1_13_R1.WorldGenFossils;
import net.minecraft.server.v1_13_R1.WorldGenGroundBush;
import net.minecraft.server.v1_13_R1.WorldGenHugeMushroom;
import net.minecraft.server.v1_13_R1.WorldGenJungleTree;
import net.minecraft.server.v1_13_R1.WorldGenMegaTree;
import net.minecraft.server.v1_13_R1.WorldGenSwampTree;
import net.minecraft.server.v1_13_R1.WorldGenTaiga1;
import net.minecraft.server.v1_13_R1.WorldGenTaiga2;
import net.minecraft.server.v1_13_R1.WorldGenTrees;
...
import org.bukkit.craftbukkit.v1_13_R1.entity.CraftComplexLivingEntity;
...
import org.bukkit.craftbukkit.v1_13_R1.entity.CraftGolem;
...
import org.bukkit.craftbukkit.v1_13_R1.entity.CraftWaterMob;
...
public class BukkitWorld implements LocalWorld
{
	...
	private Entity getEntity(Class<? extends org.bukkit.entity.Entity> clazz)
	{
		...
		{
			return new net.minecraft.server.v1_13_R1.EntityBoat(world, x, y, z);
		}
		...
		else if (org.bukkit.entity.Projectile.class.isAssignableFrom(clazz))
		{
			...
			{
				return new net.minecraft.server.v1_13_R1.EntitySnowball(world, x, y, z);
			}
			else if (org.bukkit.entity.Egg.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityEgg(world, x, y, z);
			}
			else if (Arrow.class.isAssignableFrom(clazz))
			{
				if (org.bukkit.entity.TippedArrow.class.isAssignableFrom(clazz))
				{
					...
					entity.setType(org.bukkit.craftbukkit.v1_13_R1.potion.CraftPotionUtil.fromBukkit(new org.bukkit.potion.PotionData(org.bukkit.potion.PotionType.WATER, false, false)));
					return entity;
				}
				else if (org.bukkit.entity.SpectralArrow.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntitySpectralArrow(world);
				} else {
			...
			{
				return new net.minecraft.server.v1_13_R1.EntityThrownExpBottle(world);
			}
			else if (org.bukkit.entity.EnderPearl.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityEnderPearl(world);
			}
			else if (org.bukkit.entity.ThrownPotion.class.isAssignableFrom(clazz))
			{
				...
				{
					return new net.minecraft.server.v1_13_R1.EntityPotion(world, x, y, z, CraftItemStack.asNMSCopy(new ItemStack(org.bukkit.Material.LINGERING_POTION, 1)));
				} else {
					return new net.minecraft.server.v1_13_R1.EntityPotion(world, x, y, z, CraftItemStack.asNMSCopy(new ItemStack(org.bukkit.Material.SPLASH_POTION, 1)));
				}
			}
			else if (org.bukkit.entity.Fireball.class.isAssignableFrom(clazz))
			{
				...
				{
					return new net.minecraft.server.v1_13_R1.EntitySmallFireball(world);
				}
				else if (org.bukkit.entity.WitherSkull.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityWitherSkull(world);
				}
				else if (org.bukkit.entity.DragonFireball.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityDragonFireball(world);
				} else {
					return new net.minecraft.server.v1_13_R1.EntityLargeFireball(world);
				}
			}
			else if (org.bukkit.entity.ShulkerBullet.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityShulkerBullet(world);
			}
		}
		else if (org.bukkit.entity.Minecart.class.isAssignableFrom(clazz))
		{
			...
			{
				return new net.minecraft.server.v1_13_R1.EntityMinecartFurnace(world, x, y, z);
			}
			else if (org.bukkit.entity.minecart.StorageMinecart.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityMinecartChest(world, x, y, z);
			}
			else if (org.bukkit.entity.minecart.ExplosiveMinecart.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityMinecartTNT(world, x, y, z);
			}
			else if (org.bukkit.entity.minecart.HopperMinecart.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityMinecartHopper(world, x, y, z);
			}
			else if (org.bukkit.entity.minecart.SpawnerMinecart.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityMinecartMobSpawner(world, x, y, z);
			}
			else if (org.bukkit.entity.minecart.CommandMinecart.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityMinecartCommandBlock(world, x, y, z);
			} else {
				return new net.minecraft.server.v1_13_R1.EntityMinecartRideable(world, x, y, z);
			}
		}
		else if (org.bukkit.entity.EnderSignal.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityEnderSignal(world, x, y, z);
		}
		else if (org.bukkit.entity.EnderCrystal.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityEnderCrystal(world);
		}
		else if (LivingEntity.class.isAssignableFrom(clazz))
		{
			if (org.bukkit.entity.Chicken.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityChicken(world);
			}
			else if (org.bukkit.entity.Cow.class.isAssignableFrom(clazz))
			{
				if (org.bukkit.entity.MushroomCow.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityMushroomCow(world);
				} else {
					return new net.minecraft.server.v1_13_R1.EntityCow(world);
				}
			}
			else if (org.bukkit.entity.Golem.class.isAssignableFrom(clazz))
			{
				...
				{
					return new net.minecraft.server.v1_13_R1.EntitySnowman(world);
				}
				else if (org.bukkit.entity.IronGolem.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityIronGolem(world);
				}
				else if (org.bukkit.entity.Shulker.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityShulker(world);
				}
			}
			else if (org.bukkit.entity.Creeper.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityCreeper(world);
			}
			else if (org.bukkit.entity.Ghast.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityGhast(world);
			}
			else if (org.bukkit.entity.Pig.class.isAssignableFrom(clazz))
			{
				return new net.minecraft.server.v1_13_R1.EntityPig(world);
			}
			else if (!Player.class.isAssignableFrom(clazz))
			{
				if (org.bukkit.entity.Sheep.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntitySheep(world);
				}
				else if (org.bukkit.entity.Horse.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityHorse(world);
				}
				else if (org.bukkit.entity.Skeleton.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntitySkeleton(world);
				}
				else if (org.bukkit.entity.Slime.class.isAssignableFrom(clazz))
				{
					if (org.bukkit.entity.MagmaCube.class.isAssignableFrom(clazz))
					{
						return new net.minecraft.server.v1_13_R1.EntityMagmaCube(world);
					} else {
						return new net.minecraft.server.v1_13_R1.EntitySlime(world);
					}
				}
				else if (org.bukkit.entity.Spider.class.isAssignableFrom(clazz))
				{
					...
					{
						return new net.minecraft.server.v1_13_R1.EntityCaveSpider(world);
					} else {
						return new net.minecraft.server.v1_13_R1.EntitySpider(world);
					}
				}
				else if (org.bukkit.entity.Squid.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntitySquid(world);
				}
				else if (org.bukkit.entity.Tameable.class.isAssignableFrom(clazz))
				{
					if (org.bukkit.entity.Wolf.class.isAssignableFrom(clazz))
					{
						return new net.minecraft.server.v1_13_R1.EntityWolf(world);
					}
				...
				{
					return new net.minecraft.server.v1_13_R1.EntityPigZombie(world);
				}
				else if (org.bukkit.entity.Zombie.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityZombie(world);
				}
				else if (org.bukkit.entity.Giant.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityGiantZombie(world);
				}
				else if (org.bukkit.entity.Silverfish.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntitySilverfish(world);
				}
				else if (org.bukkit.entity.Enderman.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityEnderman(world);
				}
				else if (org.bukkit.entity.Blaze.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityBlaze(world);
				}
				else if (org.bukkit.entity.Villager.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityVillager(world);
				}
				else if (org.bukkit.entity.Witch.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityWitch(world);
				}
				else if (org.bukkit.entity.Wither.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityWither(world);
				}
				else if (org.bukkit.entity.ComplexLivingEntity.class.isAssignableFrom(clazz))
				{
					...
					{
						return new net.minecraft.server.v1_13_R1.EntityEnderDragon(world);
					}
				}
				else if (org.bukkit.entity.Ambient.class.isAssignableFrom(clazz))
				{
					...
					{
						return new net.minecraft.server.v1_13_R1.EntityBat(world);
					}
				}
				else if (org.bukkit.entity.Rabbit.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityRabbit(world);
				}
				else if (org.bukkit.entity.Endermite.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityEndermite(world);
				}
				else if (org.bukkit.entity.Guardian.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityGuardian(world);
				}
				else if (org.bukkit.entity.ArmorStand.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityArmorStand(world, x, y, z);
				}
				else if (org.bukkit.entity.PolarBear.class.isAssignableFrom(clazz))
				{
					return new net.minecraft.server.v1_13_R1.EntityPolarBear(world);
				}
			}
		}
		...
		*/
		...
		{
			return new net.minecraft.server.v1_13_R1.EntityTNTPrimed(world, x, y, z, null);
		}
		else if (org.bukkit.entity.ExperienceOrb.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityExperienceOrb(world, x, y, z, 0);
		}
		...
		{
			return new net.minecraft.server.v1_13_R1.EntityFireworks(world, x, y, z, null);
		}
		else if (org.bukkit.entity.AreaEffectCloud.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityAreaEffectCloud(world, x, y, z);
		}

		if(org.bukkit.entity.Donkey.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityHorseDonkey(world);
		}
		if(org.bukkit.entity.ElderGuardian.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityGuardianElder(world);
		}
		if(org.bukkit.entity.Evoker.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityEvoker(world);
		}
		if(org.bukkit.entity.EvokerFangs.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityEvokerFangs(world);
		}
		if(org.bukkit.entity.Husk.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityZombieHusk(world);
		}
		if(org.bukkit.entity.Llama.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityLlama(world);
		}
		if(org.bukkit.entity.LlamaSpit.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityLlamaSpit(world);
		}
		if(org.bukkit.entity.Mule.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityHorseMule(world);
		}
		if(org.bukkit.entity.SkeletonHorse.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityHorseSkeleton(world);
		}
		if(org.bukkit.entity.Stray.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntitySkeletonStray(world);
		}
		if(org.bukkit.entity.Vex.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityVex(world);
		}
		if(org.bukkit.entity.Vindicator.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityVindicator(world);
		}
		if(org.bukkit.entity.WitherSkeleton.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntitySkeletonWither(world);
		}
		if(org.bukkit.entity.ZombieHorse.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityHorseZombie(world);
		}
		if(org.bukkit.entity.ZombieVillager.class.isAssignableFrom(clazz))
		{
			return new net.minecraft.server.v1_13_R1.EntityZombieVillager(world);
		}
